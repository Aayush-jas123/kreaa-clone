      ...
      <div className="space-y-8 flex-1 flex flex-col">
        ...
        <div className="py-4 border-t border-zinc-800/50">
          ...
          <div className="bg-zinc-900/40 rounded-xl p-4 border border-zinc-800/50 shadow-inner">
            ...
            <button className="w-full py-2 bg-zinc-100 hover:bg-white text-black text-[10px] font-bold rounded-lg transition-all uppercase tracking-wider active:scale-95 shadow-lg shadow-white/5">
              Upgrade Pro
            </button>
          </div>
        </div>
